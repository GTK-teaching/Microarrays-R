---
title: Importing raw microarray data into R (affy package)
teaching: 0
exercises: 0
source: Rmd
questions:
...
>> ## I recommend skipping this and going to the oligo package walkthrough.
>>
>> We used this walkthrough in the practical. However, on further consideration, I think there are advantages to the "oligo" package instead of the "affy" package. They are almost exactly the same, 
{: .callout}
