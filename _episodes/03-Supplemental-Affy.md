...
In the interest of time, don't do that. Instead, use the files you have downloaded from Canvas and
...
<img src="../fig/rmd-image_cel-1.png" alt="An image of a CEL file" width="50%" height="50%" />
<p class="caption">An image of a CEL file</p>
</div>
