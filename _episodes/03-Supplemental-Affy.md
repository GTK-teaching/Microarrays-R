...
# Instead, please edit 03-Supplemental-Affy.md in _episodes_rmd/
...
> > 
> > ~~~
> > Error in read.celfiles(list.celfiles("GSE33146", full.names = TRUE, listGzipped = TRUE)): checkChipTypes(filenames, verbose, "affymetrix", TRUE) is not TRUE
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in read.celfiles(list.celfiles("GSE66417", full.names = TRUE, listGzipped = TRUE)): checkChipTypes(filenames, verbose, "affymetrix", TRUE) is not TRUE
> > ~~~
> > {: .error}
> >
> {: .solution}
...
~~~
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'image': object 'gse33146_celdata' not found
~~~
{: .error}
